...
public class ClimbingSubsystem extends SubsystemBase {
  ...
  private SparkFlex m_PrimaryMotor =
      new SparkFlex(ClimbingConstants.kRightClimbingMotorPort, MotorType.kBrushless);
  private SparkFlex m_SecondaryMotor =
      new SparkFlex(ClimbingConstants.kLeftClimbingMotorPort, MotorType.kBrushless);
  private SparkFlexConfig primaryConfig = new SparkFlexConfig();
  private SparkFlexConfig secondaryConfig = new SparkFlexConfig();
  private SparkClosedLoopController m_ClimbingPrimaryController =
      m_PrimaryMotor.getClosedLoopController();
  ...
  public ClimbingSubsystem() {
    ...
    primaryConfig.inverted(true).idleMode(IdleMode.kBrake);
     ...
     * factors.
     */
    primaryConfig.encoder.positionConversionFactor(1).velocityConversionFactor(1);
  ...
  public void setClimbingVelocity(double targetVelocity) {
    m_ClimbingPrimaryController.setReference(
        targetVelocity, ControlType.kVelocity, ClosedLoopSlot.kSlot1);
  }
