...
public class ShooterSubsystem extends SubsystemBase {
  ...
  private SparkFlex shooterMotor =
      new SparkFlex(ShooterConstants.kShooterMotorPort, MotorType.kBrushless);
  // private SparkFlex = new SparkFlex(ShooterConstants.kCollumnMotorPort, MotorType.kBrushless);
  // private SparkFlex shooterMotor = new SparkFlex(ShooterConstants.kShooterMotorPort,
  ...
  public ShooterSubsystem() {
    ...
    // ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    // collumnMotor.configure(collumnConfig, ResetMode.kResetSafeParameters,
    // PersistMode.kPersistParameters);
