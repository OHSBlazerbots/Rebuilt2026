...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public SwerveSubsystem(File directory) {
    ...
    Pose2d startingPose =
        blueAlliance
            ? new Pose2d(new Translation2d(Meter.of(5), Meter.of(4)), Rotation2d.fromDegrees(0))
            : new Pose2d(new Translation2d(Meter.of(9), Meter.of(4)), Rotation2d.fromDegrees(180));
