...
public class IntakeSubsystem extends SubsystemBase {
  ...
  public IntakeSubsystem() {
    ...
    rollerConfig.limitSwitch.forwardLimitSwitchEnabled(false).reverseLimitSwitchEnabled(false);
     ...
     * factors.
     */
    rollerConfig.encoder.positionConversionFactor(1).velocityConversionFactor(1);
  ...
  public boolean isDown() {
    return Math.abs(pivotEncoder.getPosition() - IntakeConstants.pivotForwardSoftLimitRotations)
        <= 5.00;
  }
